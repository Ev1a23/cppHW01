...
MySimulator.o: MySimulator.cpp House.o MyAlgorithm.o RandomizedStepAlgorithm.o Algorithm_208992883_322623182_BFS.o
	$(CXX) $(CXXFLAGS) -c $< -o $@
...
Algorithm_208992883_322623182_BFS.o: Algorithm_208992883_322623182_BFS.cpp MyAlgorithm.o
	$(CXX) $(CXXFLAGS) -c $< -o $@
